...
# usuario e imprimir el resultado por pantalla. Nota: investigue uso de las funciones upper(), lower() y title() de Python para convertir entre mayúsculas y minúsculas.
...
# Convertimos fecha a un número "ordenable"
fecha = mes * 100 + dia
